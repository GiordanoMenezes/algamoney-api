...
public class AlgaMoneyExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        String mensagemDesenvolvedor = ex.getCause() == null ? ex.toString() : ex.getCause().getMessage();
    ...
    @ExceptionHandler(LancamentoPessoaInativaException.class)
    public ResponseEntity<Object> handleLanctoPessoaInativa(LancamentoPessoaInativaException ex, WebRequest request) {
